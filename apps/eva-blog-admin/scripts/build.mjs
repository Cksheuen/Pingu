...
await cp("src/authorController.js", `${dist}/src/authorController.js`);
await cp("src/styles.css", `${dist}/src/styles.css`);
await cp("src/domain/blog.js", `${dist}/src/domain/blog.js`);
await cp("src/services/authorApi.js", `${dist}/src/services/authorApi.js`);
