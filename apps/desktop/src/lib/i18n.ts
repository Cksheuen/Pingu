...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "home.egress": { en: "VERIFIED EGRESS", zh: "实际代理出口" },
  "home.egress_checking": { en: "Checking", zh: "检测中" },
  "home.egress_recheck": { en: "Check", zh: "重测" },
  "home.egress_desc": {
    en: "Measured through Pingu, not inferred from the selected node.",
    zh: "该地址由 Pingu 实际代理请求测得，并非根据节点配置推断。",
  },
